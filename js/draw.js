...
(function () {
  ...
  WC.DRAW = [
    ...
    { no: 10, name: 'Marie O Sullivan (Mick)',     team: 'CAN', scorer: 'Kylian Mbappé',        scorerCountry: 'France' },
    ...
    { no: 13, name: 'Johnny Scribbles (Bee)',      team: 'SWE', scorer: 'Bruno Fernandes',      scorerCountry: 'Portugal' },
    { no: 14, name: 'Bianca de Nicola (Bee)',      team: 'ENG', scorer: 'Mikel Oyarzabal',      scorerCountry: 'Spain' },
    ...
    { no: 18, name: 'Eoin O Donovan (Scott)',      team: 'KSA', scorer: 'Harry Kane',           scorerCountry: 'England' },
    ...
    { no: 33, name: 'Maura O Connor (Pa)',         team: 'GHA', scorer: 'Sadio Mané',           scorerCountry: 'Senegal' },
    { no: 34, name: 'Iris O Brien',                team: 'PAR', scorer: 'Vinícius Júnior',      scorerCountry: 'Brazil' },
    { no: 35, name: 'Declan O Sullivan (Philip)',  team: 'AUT', scorer: 'Enner Valencia',       scorerCountry: 'Ecuador' },
    { no: 36, name: 'Carol Geaney (Frank)',        team: 'FRA', scorer: 'Anthony Gordon',       scorerCountry: 'England' },
    { no: 37, name: 'Darren Geaney (Frank)',       team: 'BIH', scorer: 'Igor Thiago',          scorerCountry: 'Brazil' },
    { no: 38, name: 'Razor (Bluge)',               team: 'AUS', scorer: 'Mo Salah',             scorerCountry: 'Egypt' },
    { no: 39, name: 'Nicole Geaney (Frank)',       team: 'POR', scorer: 'Morgan Rogers',        scorerCountry: 'England' },
    { no: 40, name: 'Courtney O Keefe (Frank)',    team: 'MEX', scorer: 'Rafael Leão',          scorerCountry: 'Portugal' },
    ...
    { no: 43, name: 'Paul Barrett (Frank)',        team: 'TUN', scorer: 'Charles De Ketelaere', scorerCountry: 'Belgium' },
    { no: 44, name: 'Dean Smith (Frank)',          team: 'PAN', scorer: 'Ousmane Dembélé',      scorerCountry: 'France' },
    { no: 45, name: 'Johnny Kennelly (Pa)',        team: 'RSA', scorer: 'Luis Díaz',            scorerCountry: 'Colombia' },
